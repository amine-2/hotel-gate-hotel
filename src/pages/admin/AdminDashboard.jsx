...
import ChartSection from "../../components/Admin/Overview/ChartSection"
import KPISection from "../../components/Admin/Overview/KPISection"
  ...
  return (
    <div className="  p-8 pt-16 pl-16 flex flex-col justify-center items-center ">
      <h1 className="text-3xl font-bold mb-6 text-zinc-800 dark:text-zinc-300 ">
        {t("welcome")}, {profile?.full_name || 'Admin'}
      </h1>
