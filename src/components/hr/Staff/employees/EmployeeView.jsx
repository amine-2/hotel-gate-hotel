...
export default function EmployeeView({ userId }) {
  ...
  const isHotelManager = data.role === "hotel_manager";
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <EmployeeFiles
        ...
        files={files}
        setFiles={setFiles}
        editing={editing && !isHotelManager}
      />
      ...
      {/* EXTRA ACTIONS */}
      {!isHotelManager && <EmployeeActions
        data={data}
        onRefresh={load}
      />}
